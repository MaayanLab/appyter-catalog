    ...
    <div class="d-flex">
      ...
      <div class="tab-content flex-grow">
        <div class="tab-pane fade show"
          ...
          role="tabpanel">
          <div class="jumbotron">
            <h1 class="display-4">Welcome to your Appyter user account, {$auth.keycloak.tokenParsed.given_name}</h1>
            <p class="lead">
              This allows you to keep track of your generated notebooks, and configure custom providers for appyter storage and operation.
            </p>
          </div>
        </div>
        <div class="tab-pane fade show"
