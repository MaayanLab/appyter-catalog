...
The [example appyter](https://github.com/MaayanLab/appyter-catalog/tree/main/appyters/example) may act as a template, it demonstrates some appyter features and includes the fundamental structure necessary around any given appyter to be published in the catalog.
